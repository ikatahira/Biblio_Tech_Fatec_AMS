"""
Django settings for projmodel project.
...
ALLOWED_HOSTS = ['8000-ikatahira-bibliotechfat-jmacsn117kc.ws-us110.gitpod.io', 'gitpod']
...
WSGI_APPLICATION = 'projmodel.wsgi.application'
